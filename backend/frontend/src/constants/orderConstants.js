...
export const ORDER_LIST_REQUEST = "ORDER_MY_LIST_REQUEST";
export const ORDER_LIST_SUCCESS = "ORDER_MY_LIST_SUCCESS";
export const ORDER_LIST_FAIL = "ORDER_MY_LIST_FAIL";
export const ORDER_LIST_RESET = "ORDER_MY_LIST_RESET";
